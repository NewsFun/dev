...
var mobile_js_files = [
    'js/mobile/scaffold/comp.js',
    'js/mobile/scaffold/utils.js',
    'js/mobile/scaffold/dataset.js',
    'js/mobile/scaffold/router.js',
    'js/mobile/scaffold/routermap.js',
    'js/mobile/scaffold/loaddata.js',
    'js/mobile/scaffold/initialize.js',
    'js/mobile/*.js',
    'js/mobile/scaffold/entry.js'
];

gulp.task('mobile_js_concat', function () {
    gulp.src(mobile_js_files)
...
//md5-hzpnoforuseh1qm9vD051NqOIWIylcdsJeqTdaByduVUhashnodeal
//jade
...
gulp.task('sprite', function () {
  var spriteData = gulp.src('img/*.png').pipe(spritesmith({
    imgName: 'sprite.png',
    cssName: "out/test.css",//保存合并后对于css样式的地址
...
gulp.task('autowatch', function() {
    ...
    gulp.watch('js/mobile/**/*.js', ['mobile_js_concat']);
